<template>
    <div class="swiper-contorller">
        <div class="contorller-title">轮播图控件</div>
        ...
        <div class="contorller-body">
            ...
            <div class="setting-box">
                <el-form :model="settingModel" label-width="80px">
                    <el-row :gutter="10">
                        <el-col :span="12">
                            <el-form-item label="轮播方式:">
                                <el-switch v-model="settingModel.autoplay"
                        ...
                        <el-col :span="12">
                            <el-form-item label="轮播方向:">
                                <el-switch v-model="settingModel.direction"
                                    style="--el-switch-on-color: #13ce66; --el-switch-off-color: #13ce66"
                                    active-text="横向" active-value="horizontal" inactive-text="纵向"
                    ...
                    <el-row :gutter="10">
                        <el-col :span="12">
                            <el-form-item label="无限轮播:">
                                <el-switch v-model="settingModel.loop"
                                    style="--el-switch-on-color: #13ce66; --el-switch-off-color: #ff4949"
                        ...
                        <el-col :span="12">
                            <el-form-item label="轮播时间:">
                                <el-input-number v-model="settingModel.interval" :step="500" :min="500" :max="10000" />
                            </el-form-item>
                        </el-col>

                        <!-- <el-col :span="12">
                            <el-form-item label="卡片化:">
                                <el-switch v-model="settingModel.type"
                                    style="--el-switch-on-color: #13ce66; --el-switch-off-color: #ff4949"
                                    active-text="是" active-value="card" inactive-text="否" inactive-value="" />
                            </el-form-item>
                        </el-col> -->
                    </el-row>
                </el-form>
            ...
            <div class="img-list">
                        ...
                        <div class="operate-btns">
                            <div class="edit">
                                <el-popover placement="bottom" :width="420" trigger="click">
                                    <template #reference>
                                        <el-icon @click="changeImgIndex(index)">
                                            <EditPen />
                                        </el-icon>
                                    </template>

                                    <pub-picture @handleSelect="handleChangeImg"></pub-picture>
                                </el-popover>
                ...
                <el-popover ref="addImgRef" placement="bottom" :width="420" trigger="click">
                    <template #reference>
...
const modelDefault = {
    ...
    type: '', // 是否卡片化
    loop: true, // 是否无限轮播
    direction: 'horizontal' // 轮播方向 horizontal：横向 vertical：纵向
};

const addImgRef = ref(null);

const settingModel = ref<any>(modelDefault);
...
watch(() => props.data, (newVal) => {
    if (JSON.stringify(newVal) !== '{}') {
        settingModel.value = newVal.setting;
        fileList.value = newVal.list;
    } else {
        settingModel.value = modelDefault;
        fileList.value = [];
    }
...
const handleSelect = (item: { name: string, src: string }) => {
    ...
    addImgRef.value && addImgRef.value.hide();
};

const handleChangeImg = (item: { name: string, src: string }) => {
    fileList.value[imgIndex.value as number] = item;
    imgIndex.value = null;
};
...
const handleKeep = () => {
    ...
    const setting = settingModel.value;
    const list = fileList.value;
    active.data.setting = setting;
    active.data.list = list;
    element[num as number]  = active;
